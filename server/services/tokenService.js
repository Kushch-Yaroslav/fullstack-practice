...
module.exports.createAccessToken = async ({userId, email}) =>  await promisifySignJWT({userId, email}, SECRET_VALUE, {
        expiresIn: ACCESS_TIME
    });

module.exports.verifyAccessToken = async(token) => await promisifyVerifyJWT(token, SECRET_VALUE);
